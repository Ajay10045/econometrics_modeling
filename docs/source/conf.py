...
# econometrics_modelling documentation build
...
from econometrics_modelling import __version__ as release

# -- Project information -----------------------------------------------------

project = "econometrics_modelling"
author = "Kedro"
...
htmlhelp_basename = "econometrics_modellingdoc"
...
latex_documents = [
    (
        master_doc,
        "econometrics_modelling.tex",
        "econometrics_modelling Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "econometrics_modelling",
        "Project econometrics_modelling codebase.",
        "Data-Science",
    )
]
